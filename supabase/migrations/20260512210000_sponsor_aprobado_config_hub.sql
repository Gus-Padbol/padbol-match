-- Aprobación de sponsors, textos para hub, cupos globales/por plan, y SELECT público solo aprobados.
-- Ejecutar después de 20260512180000_sponsors_storage_and_rls.sql (política SELECT se reemplaza).
...
-- Patrocinadores ya cargados en producción: marcar aprobados una vez (los nuevos quedan pendientes salvo lógica de la app).
...
-- Solo sponsors activos, aprobados y en ventana de fechas (anon / jugadores).
