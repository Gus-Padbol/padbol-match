...
export const COMMERCIAL_PLANS_API_BASE = getApiBaseUrl();

export const PRO_MONTHLY_AMOUNT_USD = 68;
export const PADBOL_COURTS_PRO_DISCOUNT_PERCENT = 50;
export const PADBOL_COURTS_VENUE_SERVICE_PERCENT = 0;
export const PADBOL_COURTS_PRO_MONTHLY_AMOUNT_USD =
  PRO_MONTHLY_AMOUNT_USD * (1 - PADBOL_COURTS_PRO_DISCOUNT_PERCENT / 100);
export const PADBOL_COURTS_PRO_OBJECTIVES_DISCOUNT_PERCENT = 50;
export const PADBOL_COURTS_PRO_OBJECTIVES_MONTHLY_AMOUNT_USD =
...
export const COMMERCIAL_PLANS_PREVIEW = Object.freeze([
  ...
  },
  {
    slug: 'pro',
    name: 'Pro',
    monthlyAmount: PRO_MONTHLY_AMOUNT_USD,
    annualAmount: 680,
    currency: 'USD',
    padbolCourtsBenefit: Object.freeze({
      monthlyAmount: PADBOL_COURTS_PRO_MONTHLY_AMOUNT_USD,
      discountPercent: PADBOL_COURTS_PRO_DISCOUNT_PERCENT,
    }),
