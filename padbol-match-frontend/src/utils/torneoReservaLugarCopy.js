/** Copy del banner jugador (planificación): TorneoVista → TorneoTabbedView `bannerAntesTabs`. */

export const TORNEO_RESERVA_LUGAR_BTN = '🏆 Reservar mi lugar';

export const TORNEO_RESERVA_LUGAR_CONFIRM_POST =
  '¡Lugar reservado! Te avisamos cuando abra la inscripción. Prepará tu equipo. 🏆';
