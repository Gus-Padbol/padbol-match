...
describe('canonical Padbol ecosystem locales', () => {
  ...
  it('has direct Czech copy for the foundational admin panel', () => {
    [
      ...
      'weekdays', 'confirmaciones', 'overview', 'bookingsSummary', 'tournamentLabels', 'common', 'franjas', 'roles', 'reservas', 'jugadores', 'resenas', 'scoreboard', 'metrics', 'metricas', 'pushNotif', 'notif',
    ].forEach((section) => {
