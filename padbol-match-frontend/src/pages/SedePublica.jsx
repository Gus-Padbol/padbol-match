...
function SedeSocialLinks({ sede, t, variant = 'hero' }) {
  ...
  const labelRaw = t('sedes.publica.seguinosEn', { defaultValue: 'Síguenos en' });
      ...
      <div className="sede-publica-proximo-torneo__card sede-publica-proximo-torneo__card--empty">
        ...
        <p className="sede-publica-proximo-torneo__empty-text">
          {t('sedes.publica.sinTorneoProximo', {
            defaultValue: 'No hay torneos próximos — ¿quieres jugar uno?',
          })}
        </p>
        {enListaEspera ? (
          ...
          value={
            waHref ? (
              <a href={waHref} target="_blank" rel="noopener noreferrer">
                {t('sedes.publica.whatsappCta', { defaultValue: 'Escríbenos por WhatsApp' })}
              </a>
            ) : (
              '—'
            )
...
const API_BASE_RESENAS = getApiBaseUrl();
