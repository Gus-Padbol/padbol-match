...
describe('/plataforma public site', () => {
  ...
  it('expone navegación, CTAs prioritarios y stores no activos', () => {
    ...
    expect(screen.getAllByRole('link', { name: 'Conoce cómo sumar tu sede' })[0])
  ...
  it('explica comunidad, partidos abiertos y marcador inteligente', () => {
    ...
    expect(container.querySelector('.ps-scoreboard__snapshot')).toBeTruthy();
    expect(container.querySelector('.ps-scoreboard__video')).toBeTruthy();
    expect(container.querySelector('.ps-scoreboard__future')).toBeNull();
